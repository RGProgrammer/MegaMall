 ...
 */
package com.rgpro.megamall.ar.core.rendering;
...
public class MarkerRenderer {
  private static final String TAG = MarkerRenderer.class.getSimpleName();
  ...
  // Shader names.
  private static final String VERTEX_SHADER_NAME = "shaders/marker.vert";
  private static final String FRAGMENT_SHADER_NAME = "shaders/marker.frag";
  ...
  public void createOnGlThread(Context context, String objAssetName)
    ...
    normalsBaseAddress = verticesBaseAddress + 4 * vertices.limit();
   ...
   * s
   *
   * @param x x component of the 3d coordinates
   * @param y y component of the 3d coordinates
   * @param z z component of the 3d coordinates
   *
   */
